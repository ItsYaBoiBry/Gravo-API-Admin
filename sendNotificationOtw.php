...
function send_notification($token,$id)
{
    ...
    $msg = array
    (
        'body' => 'Your collector for #'.$id.' is en route! Please get ready!',
    ...
    if(isset($_POST["userID"])){
        ...
        if (empty($getToken)) {
            ...
            if(empty($gettcode)){
                ...
                mysqli_query($conn, "INSERT INTO notifications(recycler_id, title, message) VALUES ($user_id,'Collector en route','Your Collector for #".$code." is en route! Please get ready!');");
                mysqli_close($conn);
