...
$result = mysqli_query($conn, "SELECT * FROM recycler ORDER BY id Asc"); 
...
<div> <br/>  <br/<br/> </div>
<div align="center"> <h2>User</h2></div>
<div> <br/>  <br/<br/> </div>
    <table width='80%' border=0 id= "show_table" align="center">
        ...
        while($res = mysqli_fetch_array($result)) {     
            ...
            echo "<td><a href=\"useredit.php?email=$res[email]\">Edit</a> | <a href=\"userdelete.php?email=$res[email]\" onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";        
        }
        ?>
    </table>
</body>
