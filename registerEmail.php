...
<body style="background-color: #ebebeb; font-family: 'Open sans', sans-serif;text-align: start; font-size: 16px;color:#000000">
    ...
    <div id="page">
        <div class="toppart"
            ...
            <div class="header" style="padding: 10px;background-color: #FFFFFF;">
                ...
                <a href="https://twitter.com/GRAVOSG"><img
...
//                            width="30px" style="float: right;margin-right: 10px;"/></a>
                <a href="https://www.instagram.com/greenravolution/"><img
            ...
            <div class="w3-card"
                ...
                <div style="text-align: center;padding: 20px;">
                    <a href="https://youtu.be/ksbl_Yues4A" class="w3-card"
    ...
    <div id="page">
        <div class="toppart"
            ...
            <div class="w3-card"
                ...
                <div style="text-align: center;padding: 20px;">
                    <a href="https://greenravolution.com" class="w3-card"
